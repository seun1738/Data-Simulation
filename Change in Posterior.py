...
for j in range(30):
    ...
    plt.plot(samples_alpha_pthree, label="Trace",
    ...
    samples_beta_pone = samples_adaptive_pone[:, 1]
    samples_beta_ptwo = samples_adaptive_ptwo[:, 1]
    samples_beta_pthree = samples_adaptive_pthree[:, 1]

    # Setting the figure size
    plt.figure(figsize=(10, 6))

    # Creating the traceplot
    plt.plot(samples_beta_pone, label="Trace",
             alpha=0.7, color='dodgerblue')
    plt.plot(samples_beta_ptwo, label="Trace",
             alpha=0.7, color='orange')
    plt.plot(samples_beta_pthree, label="Trace",
             alpha=0.7, color='forestgreen')
    ...
    samples_gamma_pone = samples_adaptive_pone[:, 2]
    samples_gamma_ptwo = samples_adaptive_ptwo[:, 2]
    samples_gamma_pthree = samples_adaptive_pthree[:, 2]

    # Setting the figure size
    plt.figure(figsize=(10, 6))

    # Creating the traceplot
    plt.plot(samples_gamma_pone, label="Trace",
             alpha=0.7, color='dodgerblue')
    plt.plot(samples_gamma_ptwo, label="Trace",
             alpha=0.7, color='orange')
    plt.plot(samples_gamma_pone, label="Trace",
             alpha=0.7, color='forestgreen')
    ...
    # Setting the title
    plt.title("Trace of $\\gamma$", fontsize=16,  fontweight='bold')
    ...
    # Creating the traceplot
    plt.plot(samples_mu_pone, label="Trace",
             alpha=0.7, color='dodgerblue')
    plt.plot(samples_mu_ptwo, label="Trace",
             alpha=0.7, color='orange')
    plt.plot(samples_mu_pone, label="Trace",
             alpha=0.7, color='forestgreen')
    ...
    plt.axhline(mu, color="red", linestyle="--",
                label=f"Expected Value of $\\mu$: {mu:.2f}")
