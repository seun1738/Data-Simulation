...
plt.plot(samples_alpha, color='red', alpha=0.5)

# Adding labels, titles and legend
plt.title('The traceplot for alpha')
plt.xlabel('Iteration')
plt.ylabel('Values for alpha')
plt.legend()
plt.grid(True)
plt.show()
...
# Plotting the traceplot
plt.plot(samples_beta, color='blue', alpha=0.1)

# Adding labels, titles and legend
plt.title('The traceplot for beta')
plt.xlabel('Iteration')
plt.ylabel('Values for beta')
plt.legend()
plt.grid(True)
plt.show()

# Setting the x-axis to be the rates of community aqusition.
samples_alpha = samples[:, 2]

# Setting the figure size
plt.figure(figsize=(10, 6))

# Plotting the traceplot
plt.plot(samples_alpha, color='green', alpha=0.8)

# Adding labels, titles and legend
plt.title('The traceplot for gamma')
plt.xlabel('Iteration')
plt.ylabel('Values for gamma')
plt.legend()
plt.grid(True)
plt.show()
